...
>(({ className, ...props }, ref) => (
  <SliderPrimitive.Root
    ...
    {...props}
  >
    <SliderPrimitive.Track className="relative h-2 w-full grow overflow-hidden rounded-full bg-red-500 dark:bg-gray-200">
      <SliderPrimitive.Range className="absolute h-full bg-red-500 dark:bg-red-500" />
